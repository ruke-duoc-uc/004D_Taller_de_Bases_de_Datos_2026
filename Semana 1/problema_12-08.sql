-- Esta linea permite que Oracle SQL Developer pueda imprimir
-- en la consola con DBMS_OUTPUT.PUT_LINE
SET SERVEROUTPUT ON;
DECLARE
-- Primero se debe crear el tipo de dato record
...
-- Cuando este creado se debe declarar una variable del tipo de dato
-- Este proceso se conoce como "inicializar"
...
BEGIN
    ...
    WHERE C.CLIENTE_ID = 12;
    DBMS_OUTPUT.PUT_LINE(SET SERVEROUTPUT ON'*****BOLETA ELECTRONICA PUNTO TICKET*****');
